...
<body class="bg-gray-100">
  <div class="container mx-auto p-4 flex-row">
    ...
    <a href="export.php" class="font-bold py-2 px-4 bg-blue-500 hover:bg-blue-700 text-white rounded mb-4 inline-block">Export As Pdf</a>
